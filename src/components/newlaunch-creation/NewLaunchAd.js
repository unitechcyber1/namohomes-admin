...
import { changeUrlStatus, deleteUrls, getAllUrls } from "./NewLaunchService";
function NewLaunchAd() {
  ...
  return (
    <div className="mx-5 mt-3">
      ...
      <div className="table-box space-table-box">
        <div className="table-top-box">All New Launch Ad Module</div>
