...
export const saveUrls = async (data) => {
    try {
      ...
      throw createUserFriendlyError(error, "Failed to save URL. Please check all fields and try again.");
    }
  }
  ...
  export const changeUrlStatus = async (
    ...
    try {
      ...
      throw createUserFriendlyError(error, "Failed to update URL status. Please try again.");
    }
  };
